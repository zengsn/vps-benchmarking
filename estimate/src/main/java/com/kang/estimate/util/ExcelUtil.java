...
public class ExcelUtil {
    ...
    public static List<List<String>> readExcel(String filePath,Integer sheetNum) {
        ...
        try {
            ...
            dataLst = read(is, isExcel2003,sheetNum);
    ...
    private static List<List<String>> read(InputStream inputStream, boolean isExcel2003,Integer sheetNum) {
        List<List<String>> dataLst = null;
        try {
            //根据版本选择创建Workbook的方式
            Workbook wb = null;
    ...
    private static List<List<String>> read(Workbook wb,Integer sheetNum) {
        int totalRows = 0;
        int totalCells = 0;
